...
//
//  Created by Ryan Anderson on 10/14/20.
//
...
class QuestionViewController: UIViewController {
    ...
    var questions: [Question] = [
        Question(
            text: "A man in the bar comes up to you and says he wants to fight. How do you respond?",
            type: .single,
            answers: [
                Answer(text: "-Let's Go!", type: .baratheon),
        ...
        Question(
            ...
            type: .multiple,
            answers: [
                Answer(text: "Red", type: .lannister),
